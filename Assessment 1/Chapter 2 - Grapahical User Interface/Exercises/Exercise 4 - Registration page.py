...
banner = PhotoImage(file='Chapter 2 - Grapahical User Interface\Exercises\RAK.png', width=480, height=120)  # The Path has been written for vscode as pycharm cannot read it
